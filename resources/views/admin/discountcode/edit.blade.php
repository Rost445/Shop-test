                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right mx-2">
                            <li class="breadcrumb-item"> {{ Breadcrumbs::render('discount_code.edit') }}
                            </li>
                          </ol>
                    </div>
                </div>
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        placeholder="Введіть назву коду знижки" required value="{{ old('name', $getRecord->name) }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control text-primary border border-primary" name="type"
                                        ...
                                        <option {{ old('type',$getRecord->type) == 'Процент' ? 'selected' : '' }}value="Процент">Процент
                                        </option>
                                        <option {{ old('type',$getRecord->type) == 'Сума' ? 'selected' : '' }} value="Сума">Сума
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="percent_amount" class="form-control"
                                        placeholder="Процент / Сума" required value="{{ old('percent_amount', $getRecord->percent_amount) }}">
                                </div>
                                <div class="form-group">
