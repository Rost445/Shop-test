                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right mx-2">
                            <li class="breadcrumb-item"> {{ Breadcrumbs::render('discount_code.list') }}
                            </li>
                          </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('admin/discount_code/add') }}" class="btn btn-primary btn-flat my-2"><i class="fas fa-plus"></i> Додати знижку</a>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('admin/discount_code/edit/' . $value->id) }}"
                                                            ...
                                                            <td><a href="{{ url('admin/discount_code/delete/' . $value->id) }}"
