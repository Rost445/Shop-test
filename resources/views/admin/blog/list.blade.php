                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('admin/blog/add') }}" class="btn btn-primary btn-flat my-2"><i
                                        class="fas fa-plus"></i> Додати Блог</a>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach ($getRecord as $value)
                                                <tr>
                                                    ...
                                                    <td><img src="{{ $value->getImage() }}" alt="" class="img-thumbnail my-2" style="height: 100px"></td>
                                                    @endif
                                                    <td>{{ $value->title }}</td>
                                                    <td>{{ $value->slug }}</td>
                                                    ...
                                                    <td><a href="{{ url('admin/blog/edit/' . $value->id) }}"
                                                            class="btn  btn-primary btn-flat"><i
                                                                class="fas fa-edit"></i></a></td>
                                                    <td><a href="{{ url('admin/blog/delete/' . $value->id) }}"
