                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right mx-2">
                            <li class="breadcrumb-item"> {{ Breadcrumbs::render('slider.add') }}
                            </li>
                          </ol>
                    </div>
                </div>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Назва слайдера<span class="text-danger">*</span></label>
                                        <input type="text" name="title" class="form-control"
                                            placeholder="Введіть назву слайдера" required value="{{ old('title') }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputFile">Зображення слайдера<span
                                    ...
                                    <div class="form-group">
                                        <label>Назва кнопки<span class="text-danger"></span></label>
                                        <input type="text" name="button_name" class="form-control"
                                            placeholder="Введіть назву кнопки" value="{{ old('button_name') }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Посилання кнопки<span class="text-danger"></span></label>
                                        <input type="text" name="button_link" class="form-control"
                                            placeholder="Введіть посилання на кнопку" value="{{ old('button_link') }}">
                                    </div>
                                    <div class="form-group">
