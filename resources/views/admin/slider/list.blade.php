                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right mx-2">
                            <li class="breadcrumb-item"> {{ Breadcrumbs::render('slider.list') }}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('admin/slider/add') }}" class="btn btn-primary my-2 btn-flat"><i
                                        class="fas fa-plus"></i> Додати слайдер
                                </a>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {!! $value->status == 0
                                                            ...
                                                            : '<i class="fas fa-minus-circle text-secondary"></i>' !!}</td>
                                                    <td>
                                                    ...
                                                    <td><a href="{{ url('admin/slider/delete/' . $value->id) }}"
