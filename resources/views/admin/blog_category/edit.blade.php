                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right mx-2">
                            <li class="breadcrumb-item"> {{ Breadcrumbs::render('blog_category.edit') }}
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="Введіть назву категорії  блогу" required
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="meta_description" class="form-control" placeholder="Введіть мета опис категорії  блогу">{{ old('meta_description', $getRecord->meta_description) }}</textarea>
                                    </div>
