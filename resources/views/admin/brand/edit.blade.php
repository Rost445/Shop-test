                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right mx-2">
                            <li class="breadcrumb-item"> {{ Breadcrumbs::render('brand.edit') }}
                            </li>
                          </ol>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="Введіть назву бренду" required value="{{ old('name',$getRecord->name) }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="meta_description" class="form-control" placeholder="Введіть мета опис бренду">{{ old('meta_description',$getRecord->meta_description) }}</textarea>
                                    </div>
