                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right mx-2">
                            <li class="breadcrumb-item"> {{ Breadcrumbs::render('sub_category.list') }}
                            </li>
                          </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('admin/sub_category/add') }}" class="btn btn-primary btn-flat my-2"><i class="fas fa-plus"></i> Додати Підкатегорію</a>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach($getRecord as $value)
                                            <tr>
                                                ...
                                                <td><a href="{{ url('admin/sub_category/edit/' . $value->id) }}"
                                                        class="btn btn-primary btn-flat"><i class="fas fa-edit"></i></a> </td>
                                                        <td><a href="{{ url('admin/sub_category/delete/' . $value->id) }}"
