                            ...
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="register-tab" data-toggle="tab" href="#register"
                                        role="tab" aria-controls="register" aria-selected="false">Реєстрація</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="tab-content-5">
                                <div class="tab-pane fade show active" id="signin" role="tabpanel"
                                    ...
                                    <form action="" id="SubmitFormLogin" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="singin-email">Електронна адреса <span
                                        ...
                                        <div class="form-group position-relative">
                                            <label for="singin-password">Пароль <span
                                                    class="text-danger">*</span></label>
                                            <input type="password" class="form-control" id="singin-password"
                                                name="password" required>
                                            <i class="toggle-password fas fa-eye" data-target="singin-password"
                                                style="position: absolute; top: 70%; right: 10px; transform: translateY(-19%); cursor: pointer;"></i>
                                        </div>
                                        ...
                                        <div class="form-footer">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="is_remember" class="custom-control-input"
                                                    id="signin-remember">
                                                <label class="custom-control-label" for="signin-remember">Запам'ятати
                                                    мене
                                                </label>
                                            </div>

                                            <a href="{{ url('forgot-password') }}"
                                                class="ml-auto text-primary forgot-link">Забули пароль?</a>
                                        </div>
                                    </form>
                                    <!-- .End Login Form -->
                                    <!--///////////////////////////////////////////////////////////////////////////-->
                                ...
                                <div class="tab-pane fade" id="register" role="tabpanel"
                                    ...
                                    <form action="" id="SubmitFormRegister" method="post">
                                        {{ csrf_field() }}
                                        <div class="form-group position-relative">
                                            <label for="register-name">Ім'я <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="register-name"
                                                name="name" required>
                                        </div>

                                        <div class="form-group position-relative">
                                            <label for="register-email">Електронна адреса <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group position-relative">
                                            <label for="register-password">Пароль<span
                                                    class="text-danger">*</span></label>
                                            <input type="password" class="form-control" id="register-password"
                                                name="password" required>
                                            <i class="toggle-password fas fa-eye" data-target="register-password"
                                                style="position: absolute; top: 70%; right: 10px; transform: translateY(-19%); cursor: pointer;"></i>
                                        </div>
                                        ...
                                        <div class="form-footer">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="register-policy">Я згідний
                                                    з <a href="#">Політика конфіденційності</a> *</label>
                                            </div>
                                        </div>
                                    </form>
                                    <!-- .End Register Form -->
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.is_wishlist == 0) {
                        $('.add-to-wishlist' + product_id).removeClass(' ');
                    } else {
        ...
        document.querySelectorAll('.toggle-password').forEach(toggle => {
            toggle.addEventListener('click', function() {
                ...
                if (input.type === 'password') {
                    ...
                    this.classList.add('fa-eye-slash'); // Замените на соответствующую иконку
                } else {
                    input.type = 'password';
                    this.classList.remove('fa-eye-slash');
                    this.classList.add('fa-eye'); // Замените на соответствующую иконку
                }
            });
        });
    </script>
