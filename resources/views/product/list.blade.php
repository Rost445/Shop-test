        ...
        <div class="page-header text-center" style="background-image: url('{{ url('assets/images/page-header-bg.jpg') }}')">
            <div class="container">
                ...
                @elseif(!empty($getCategory))
                    <h1 class="h1">{{ $getCategory->name }}</h1>
                @else
                    <h1 class="page-title">Результати пошуку: "{{ Request::get('q') }}"</h1>
                @endif
            </div>
        </div>
        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:;">Магазин</a></li>
                    @if (!empty($getSubCategory))
                        ...
                        <div class="toolbox">
                            <div class="toolbox-left">
                                <div class="toolbox-info">
                                    Показано <span>{{ $getProduct->total() }} із {{ $getProduct->perPage() }}</span> шт.
                                </div>
                            </div>
...
<option value="id_desc">За ID (спочатку нові)</option>
                        ...
                        <div class="text-center">
                            <a name="javascript:;" @if (empty($page)) class="d-none" @endif
                                data-page="{{ $page }}" class="btn btn-primary LoadMore" href="#"
                                role="button">Показати
                                більше</a>
                        </div>
                    ...
                    <aside class="col-lg-3 order-lg-first">
                        <form action="" id="FilterForm" method="POST">
                            {{ csrf_field() }}
                            <div class="input-group"><input type="hidden" name="q"
                                    value="{{ !empty(Request::get('q')) ? Request::get('q') : '' }}" class="form-control">
                            </div>

                            <div class="input-group"><input type="hidden" name="old_sub_category_id"
                                    value="{{ !empty($getSubCategory) ? $getSubCategory->id : '' }}" class="form-control">
                            </div>

                            <div class="input-group"><input type="hidden" name="old_category_id"
                                    value="{{ !empty($getCategory) ? $getCategory->id : '' }}" class="form-control"> </div>

                            <div class="input-group"><input type="hidden" name="sub_category_id" id="get_sub_category_id"
                                    class="form-control"> </div>
                            <div class="input-group"><input type="hidden" name="brand_id" id="get_brand_id"
                                    class="form-control"></div>
                            ...
                            <div class="input-group"><input type="hidden" name="start_price" id="get_start_price"
                                    class="form-control"></div>
                            <div class="input-group"><input type="hidden" name="end_price" id="get_end_price"
                                    class="form-control"></div>
                        </form>
                        <div class="sidebar sidebar-shop">
                            <div class="widget widget-clean">
                                <label>Фільтри:</label>
                                <a href="#" class="sidebar-filter-clear">Очистити</a>
                            </div>
