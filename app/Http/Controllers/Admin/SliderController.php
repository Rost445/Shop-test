...
class SliderController extends Controller
{
    ...
    public function add()
    {
        $data['header_title'] = 'Додати слайдер';
    ...
    public function insert(Request $request)
    {
        ...
        return redirect('admin/slider/list')->with('success', 'Слайдер успішно створено!');
    }
    ////////////////////////////////////////////////////////
    // Edit Category
    public function edit($id)
    {
        ...
        $data['header_title'] = 'Редагувати слайдер';
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/slider/list')->with('success', 'Слайдер успішно оновлено!');
    }
    ////////////////////////////////////////////////////////
    // Delete Category
    public function delete($id)
    {
        ...
        return redirect()->back()->with('success', 'Слайдер успішно видалено!');
    }
}
